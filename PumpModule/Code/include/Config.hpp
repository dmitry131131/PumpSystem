...
const unsigned MS1_PIN    =  6;   // MS1
const unsigned MS2_PIN    =  5;   // MS2
const unsigned MS3_PIN    =  4;   // MS3
...
// Indication
const unsigned GREEN_INDICATOR_PIN = 17;    // Arduino nano (A3)
const unsigned RED_INDICATOR_PIN = 14;  // Arduino nano (A0)

// Safety switch
const unsigned FORWARD_SWITCH_PIN = 16; // Arduino nano (A2)
const unsigned REVERSE_SWITCH_PIN = 15; // Arduino nano (A1)
